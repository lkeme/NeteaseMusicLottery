...
class NetEaseLottery:
    ...
    def filter_prizes(self, prizes):
        keys = [
            ...
            '定制logo', '惊喜软件', '终于中奖', '加群', '第一批粉丝', '祝大家',
            '内部群', '老粉', '仅关注', '仅我关注', '打字粉丝ID', '手打粉丝ID',
            '人声采集', '采样包', '约稿', 'remix', '明信片', '感受中奖', '快落',
            '中奖的快乐', '单曲', '主题创作', '猎妈', '签名照', '数字专辑', '除夕夜',
            '专辑', '励志的话', '亲笔签名', 'up', '扫码进群', '粉丝群', '签名写真',
            '纹身', '祝你', '红包雨', '电子书', '我', '专辑', '好友位', '豪车优惠',
            '观众老爷', '的支持', '拉黑', '黑名单', '脸皮厚', '没有奖品', '无奖',
            '测试', '测试', '测试', '脚本', '抽奖号', '星段位', '星段位', '圣晶石',
            '水晶', '水晶', '万兴神剪手', '万兴神剪手', 'ceshi', 'QQ', '测试',
            '自付邮费', '自付邮费', 'test', 'Test', 'TEST', '加密', '测试用',
            'VX', 'vx', 'ce', 'shi', '这是一个', 'lalall', '第一波', '第二波',
            '策是', '我是抽奖', '照片', '穷', '0.5', '一角', '冥币', '加速器',
            '硬币', '无奖品', '白名单', '圣晶石', '奖品B', '奖品C', '五毛', '第三波',
            '0.1', '五毛二', '一分', '一毛', '0.52', '0.66', '0.01', '0.77', '0.16',
            '0.88', '双排', '1毛', '1分', '1角', 'P口罩', '素颜', '写真', '图包',
            '自拍', '日历', '0.22', '房间抽奖', 'CESHI', '脸皮厚', 'ceshi', '奖品A',
            '抽奖标题', '測試', '越南盾', '啥都没有', '哈哈哈', '作曲', '一首', '手绘',
